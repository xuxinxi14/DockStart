...
## V0.9.3 Full Bundled Python Packages
...
| NumPy 2.4.6 | Scientific Python dependency | BSD-3-Clause AND 0BSD AND MIT AND Zlib AND CC0-1.0 | Python wheel dependency | Yes, local package artifact only |

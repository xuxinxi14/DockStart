...
既有统一验收已完成后端、前端、Rust 和 TypeScript/Vite 生产构建基线；评价模式、Vina/Vinardo maps、100 项批筛、BACE_1 与三条标准 AD4 独立真实 verifier 均有对应证据。v0.14.1 完成稳定化和三条必要外部门禁；v1.0.3 延续文件事务、并发状态、桌面进程边界与发布门禁，不改变科学协议。完整安装生命周期与首个公开 Release 继续保持延期。

...
class FilterCatalogEntry(Boost.Python.instance):
    ...
    def ClearProp(self, key: typing.Any) -> None:
        """
            C++ signature :
                void ClearProp(class RDKit::FilterCatalogEntry {lvalue},class std::basic_string_view<char,struct std::char_traits<char> >)
        """
    ...
    def GetProp(self, key: typing.Any) -> str:
        """
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetProp(class RDKit::FilterCatalogEntry {lvalue},class std::basic_string_view<char,struct std::char_traits<char> >)
        """
    ...
    def SetProp(self, key: typing.Any, val: str) -> None:
        """
            C++ signature :
                void SetProp(class RDKit::FilterCatalogEntry {lvalue},class std::basic_string_view<char,struct std::char_traits<char> >,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    @typing.overload
    def __init__(self) -> None:
        """

...
class MMFFMolProperties(Boost.Python.instance):
    ...
    def GetMMFFAngleTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFAngleTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    ...
    def GetMMFFBondTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFBondTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    def GetMMFFDielectricConstant(self) -> float:
        """
            ...
            C++ signature :
                double GetMMFFDielectricConstant(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    def GetMMFFDielectricModel(self) -> int:
        """
            ...
            C++ signature :
                unsigned char GetMMFFDielectricModel(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    def GetMMFFEleTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFEleTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    ...
    def GetMMFFOopTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFOopTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    ...
    def GetMMFFStretchBendTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFStretchBendTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    ...
    def GetMMFFTorsionTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFTorsionTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    def GetMMFFVariant(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetMMFFVariant(class ForceFields::PyMMFFMolProperties {lvalue})
        """
    ...
    def GetMMFFVdWTerm(self) -> bool:
        """
            ...
            C++ signature :
                bool GetMMFFVdWTerm(class ForceFields::PyMMFFMolProperties {lvalue})
        """
